...
# TOD: 2. Have someone on your team run this program, as is, on the EV3 and make sure everyone understands the code.
...
def main():
    ...
    # TOO: 3. Just below this comment add SIMPLE (no lambda) callbacks for:
...
# TOO: 4. Implement the up, down, left, and right callback functions as follows:
