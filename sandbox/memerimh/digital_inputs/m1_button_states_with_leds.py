...
Much like we did in yatesjp of the motors unit, later we will show you different (better) ways to use buttons.

Authors: David Fisher and Mattias Memering.
"""  # TOO: 1. PUT YOUR NAME IN THE ABOVE LINE.

# TOO: 2. Have someone on your team run this program as is on the EV3 and make sure everyone understands the code.
...
def main():
    ...
    while True:
        # ODO: 3. Implement the left, right, and up buttons as follows:
        ...
        if btn.right == True:
            ...
            ev3.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.RED)
            time.sleep(.1)
        # TOO: 4. Implement the down button to change the color of both LEDs.
        ...
        if btn.down == True:
            ev3.Leds.set_color(ev3.Leds.LEFT, led_colors[current_color_index+1])
            ev3.Leds.set_color(ev3.Leds.RIGHT, led_colors[current_color_index+1])
