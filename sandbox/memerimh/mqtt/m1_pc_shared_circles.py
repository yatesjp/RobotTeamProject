...
# TOD: 2. Select one team member to open libs/mqtt_remote_method_calls.py and complete the TO DO that is in that file.
...
# ODO: 3. Run this program as is on your computer and watch the logs as you click in the window.
...
# TOO: 4. Uncomment the code below.  It imports a library and creates a relatively simple class.
...
def main():
    ...
    # TOO: 5. Delete the line below (mqtt_client = None) then uncomment the code below.  It creates a real mqtt client.
...
def left_mouse_click(event, mqtt_client):
    ...
    # TOO: 6. Talk to your team members and have everyone pick a unique color.
